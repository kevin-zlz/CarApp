<template>
  <div class="container" >
    <div class="order-head">
      <div>我的文章</div>
      <div class="date" style="border: solid 1px gray">
    ...
    <div class="order-state">
      ...
      <div class="order-container">
        ...
        <div style="height: 100px;background-color: #22A7F0" v-show="'全部文章'===flag">
        ...
        <!--<div id="short-content" class="table-content"><div class="table-data">-->
            <!--<div class="info-car">-->
